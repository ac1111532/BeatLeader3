...
{
    public class Scores1Controller : Controller
    {
        private readonly BeatLeader3ContextDb _context;

        public Scores1Controller(BeatLeader3ContextDb context)
        {
            _context = context;
        }
