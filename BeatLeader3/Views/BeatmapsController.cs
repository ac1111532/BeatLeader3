...
namespace BeatLeader3.Views
{
    public class BeatmapsController : Controller
    {
        private readonly BeatLeader3ContextDb _context;

        public BeatmapsController(BeatLeader3ContextDb context)
        {
            _context = context;
        }
        ...
        {
            var beatLeader3ContextDb = _context.Beatmap.Include(b => b.song);
            return View(await beatLeader3ContextDb.ToListAsync());
        }
